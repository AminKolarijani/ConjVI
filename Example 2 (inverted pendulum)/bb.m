...
% Disclosure: This routine is borrowed from the LLT MATLAB package 
% avialable at "netlib.org/numeralgo/na13"; see also
...
%
% bb computes the planar convex hull of the set (X(i),Y(i)).

...
% Please see Section 4.2 of the athe following article for more details:
%   
...
while i_N <= length(N_set) % iteraton over grid sizes
    ...
    str = sprintf('Ex_2d_Data_N%2.0f',N(1));
...
i_N = length(N_set);
N = N_set(i_N);
str = sprintf('Ex_2d_Data_N%2.0f',N);
load(str)

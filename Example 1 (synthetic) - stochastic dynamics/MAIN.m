...
% Please also Section 4.1 of the the following article for more details:
%   
...
while i_N <= length(N_set) % iteraton over grid sizes
    ...
    str = sprintf('Ex_1s_Data_N%2.0f',N(1));
...
i_N = length(N_set);
N = N_set(i_N);
str = sprintf('Ex_1s_Data_N%2.0f',N);
load(str)
